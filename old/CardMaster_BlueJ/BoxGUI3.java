...
public class BoxGUI3 extends JFrame {
  // Anfang Attribute
  ...
  public void jButton1_ActionPerformed(ActionEvent evt) {
    kk.addCard(3, new Karte(jTextField1.getText(), jTextField2.getText()));
