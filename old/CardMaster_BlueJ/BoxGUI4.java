...
public class BoxGUI4 extends JFrame {
  // Anfang Attribute
  ...
  public void jButton1_ActionPerformed(ActionEvent evt) {
    kk.addCard(4, new Karte(jTextField1.getText(), jTextField2.getText()));
